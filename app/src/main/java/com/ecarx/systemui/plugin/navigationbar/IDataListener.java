...
public interface IDataListener extends IInterface {
    void onImageReady(IShortCut iShortCut) throws RemoteException;

    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements IDataListener {
        private static final String DESCRIPTOR = "com.ecarx.systemui.plugin.navigationbar.IDataListener";
        static final int TRANSACTION_onImageReady = 1;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            onImageReady(parcel.readInt() != 0 ? IShortCut.CREATOR.createFromParcel(parcel) : null);
        ...
        private static class Proxy implements IDataListener {
            ...
            public void onImageReady(IShortCut iShortCut) throws RemoteException {
                ...
                try {
                    ...
                    if (iShortCut != null) {
                        obtain.writeInt(1);
                        iShortCut.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
